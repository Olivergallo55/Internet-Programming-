...
public class VerifyHandler {
	...
	public static void main(String[] args) {
		...
		initVerification(args[0], key, 
				args[2]);
		
	}

	//Initiates the verification process, retains the public key, signature and connects it to the data file
	...
	// Method to retain the public key in able to verify it
